                        ...
                        <div class="card-body p-4 p-md-5 text-center">
                            ...
                            <div class="bg-black bg-opacity-50 rounded-4 p-4 mb-4 border border-white border-opacity-10">
                                <div class="d-flex align-items-center justify-content-center mb-3">
                                    ...
                                    <span class="fw-bold db-status-text text-light mono">CHECKING...</span>
                                </div>
                            ...
                            <div class="d-grid gap-3">
                                <a href="index.php" class="btn btn-success btn-lg py-3 rounded-pill shadow db-enter-btn d-none">ENTER NOW</a>
